...
(
    ...
    einkommen_kanton        float,
    einkommen_gemeinde      VARCHAR(256),
    einkommen_kirche_ref    float,
    einkommen_kirche_roem   float,
    einkommen_kirche_christ float,
    vermoegen_kanton        float,
    vermoegen_gemeinde      float,
    vermoegen_kirche_ref    float,
    vermoegen_kirche_roem   float,
    vermoegen_kirche_christ float,
    gewinn_kanton           float,
    gewinn_gemeinde         VARCHAR(256),
    gewinn_kirche           float,
    kapital_kanton          float,
    kapital_gemeinde        float,
    kapital_kirche          float
);

CREATE TABLE admin_codes
(
    Load_DTS TIMESTAMP,
    CECODID  varchar(128) PRIMARY KEY,
    CMERKM   varchar(128),
...
CREATE TABLE stage.immoscout_mieten
(
    id                      VARCHAR(256) DEFAULT NULL,
    fullId                  VARCHAR(256) DEFAULT NULL,
    street                  VARCHAR(256) DEFAULT NULL,
    title                   VARCHAR(256) DEFAULT NULL,
    type                    VARCHAR(256) DEFAULT NULL,
    city                    VARCHAR(256) DEFAULT NULL,
    country                 VARCHAR(256) DEFAULT 'Switzerland',
    Anzahl_Badezimmer       VARCHAR(256) DEFAULT NULL,
    Anzahl_Etagen           VARCHAR(256) DEFAULT NULL,
    Anzahl_Wohnungen        VARCHAR(256) DEFAULT NULL,
    Anzahl_Zimmer           VARCHAR(256) DEFAULT NULL,
    Baujahr                 VARCHAR(256) DEFAULT NULL,
    Etage                   VARCHAR(256) DEFAULT NULL,
    Grundstueckflaeche      VARCHAR(256) DEFAULT NULL,
    Inseratenummer          VARCHAR(256) DEFAULT NULL,
    Kubatur                 VARCHAR(256) DEFAULT NULL,
    Letztes_Renovationsjahr VARCHAR(256) DEFAULT NULL,
    Miete                   VARCHAR(256) DEFAULT NULL,
    Mindestnutzflaeche      VARCHAR(256) DEFAULT NULL,
    Nebenkosten             VARCHAR(256) DEFAULT NULL,
    Nettomiete              VARCHAR(256) DEFAULT NULL,
    Nutzflaeche             VARCHAR(256) DEFAULT NULL,
    Objekt_Ref              VARCHAR(256) DEFAULT NULL,
    Objekttyp               VARCHAR(256) DEFAULT NULL,
    Raumhoehe               VARCHAR(256) DEFAULT NULL,
    Verfuegbarkeit          VARCHAR(256) DEFAULT NULL,
    Wohnflaeche             VARCHAR(256) DEFAULT NULL,
    description             TEXT         DEFAULT NULL
);

CREATE TABLE stage.immoscout_kaufen
(
    id                      VARCHAR(256) DEFAULT NULL,
    fullId                  VARCHAR(256) DEFAULT NULL,
    street                  VARCHAR(256) DEFAULT NULL,
    ...
    Anzahl_Zimmer           VARCHAR(256) DEFAULT NULL,
    Baujahr                 VARCHAR(256) DEFAULT NULL,
    Bruttorendite           VARCHAR(256) DEFAULT NULL,
    Etage                   VARCHAR(256) DEFAULT NULL,
    Grundstueckflaeche      VARCHAR(256) DEFAULT NULL,
    Inseratenummer          VARCHAR(256) DEFAULT NULL,
    Kaufpreis               VARCHAR(256) DEFAULT NULL,
    Kubatur                 VARCHAR(256) DEFAULT NULL,
    Letztes_Renovationsjahr VARCHAR(256) DEFAULT NULL,
    Mindestnutzflaeche      VARCHAR(256) DEFAULT NULL,
    Nutzflaeche             VARCHAR(256) DEFAULT NULL,
...
CREATE TABLE stage.immoscout_keywords
(
    fullId  VARCHAR(256) DEFAULT NULL,
    keyword VARCHAR(512) DEFAULT NULL
);

CREATE TABLE immoscout_mieten
(
    Load_DTS                TIMESTAMP,
    id                      VARCHAR(256) DEFAULT NULL,
    fullId                  VARCHAR(256) DEFAULT NULL,
    ...
    Inseratenummer          VARCHAR(256) DEFAULT NULL,
    Kubatur                 VARCHAR(256) DEFAULT NULL,
    Letztes_Renovationsjahr BIGINT       DEFAULT NULL,
    Miete                   BIGINT       DEFAULT NULL,
    Mindestnutzflaeche      VARCHAR(256) DEFAULT NULL,
    Nebenkosten             BIGINT       DEFAULT NULL,
    Nettomiete              BIGINT       DEFAULT NULL,
    Nutzflaeche             VARCHAR(256) DEFAULT NULL,
    Objekt_Ref              VARCHAR(256) DEFAULT NULL,
    Objekttyp               VARCHAR(256) DEFAULT NULL,
    Raumhoehe               VARCHAR(256) DEFAULT NULL,
    Verfuegbarkeit          VARCHAR(256) DEFAULT NULL,
    Wohnflaeche             BIGINT       DEFAULT NULL,
    description             TEXT         DEFAULT NULL
);

CREATE TABLE immoscout_kaufen
(
    Load_DTS                TIMESTAMP,
    id                      VARCHAR(256) DEFAULT NULL,
    fullId                  VARCHAR(256) DEFAULT NULL,
...
CREATE TABLE immoscout_keywords
(
    fullId  VARCHAR(256) DEFAULT NULL,
    keyword VARCHAR(512) DEFAULT NULL
);

DROP VIEW IF EXISTS v_entry_immoscout_listing;

CREATE VIEW v_entry_immoscout_listing AS
(
select MAX(ae.egaid) AS egaid, im.fullid
from public.immoscout_mieten im
         left join admin_entry ae on concat(ae.strname, ' ', ae.deinr, ' ', ae.dplz4, ' ', ae.dplzname) =
                                     concat(im.street, ' ', im.city)
         left join admin_building ab on ae.egid = ab.egid
where ae.egid is not null
group by im.fullid
UNION ALL
select MAX(ae.egaid) AS egaid, im.fullid
from public.immoscout_kaufen im
         left join admin_entry ae on concat(ae.strname, ' ', ae.deinr, ' ', ae.dplz4, ' ', ae.dplzname) =
                                     concat(im.street, ' ', im.city)
         left join admin_building ab on ae.egid = ab.egid
where ae.egid is not null
...
DROP VIEW IF EXISTS v_keywords_immoscout_kaufpreis;


CREATE VIEW v_keywords_immoscout_kaufpreis AS
(
select fullid, kaufpreis
from immoscout_kaufen);
